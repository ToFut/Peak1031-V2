...
export const ROLE_CONFIGS: Record<UserRole, RoleConfig> = {
  admin: {
    ...
    ui: {
      sidebar_items: ['overview', 'exchanges', 'tasks', 'users', 'agencies', 'deepdive', 'documents', 'templates', 'system'],
  ...
  client: {
    ...
    ui: {
      sidebar_items: ['overview', 'my_exchanges', 'my_tasks', 'documents', 'settings'],
  ...
  coordinator: {
    ...
    ui: {
      sidebar_items: ['overview', 'exchanges', 'tasks', 'contacts', 'documents', 'settings'],
  ...
  third_party: {
    ...
    ui: {
      sidebar_items: ['overview', 'exchanges', 'documents', 'settings'],
  ...
  agency: {
    ...
    ui: {
      sidebar_items: ['overview', 'service_portfolio', 'our_team', 'documents', 'performance', 'settings'],
