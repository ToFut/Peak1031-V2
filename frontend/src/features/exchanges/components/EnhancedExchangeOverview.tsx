...
import { extractRichExchangeData, EnhancedExchangeData } from '@/shared/utils/utils/exchangeDataExtractor';
              ...
              <div>
                ...
                <p className="text-sm text-blue-600">
                  {data.coordinatorEmail || (
                    <span className="text-gray-400 italic">Contact via office</span>
                  )}
                </p>
              </div>
            </div>
