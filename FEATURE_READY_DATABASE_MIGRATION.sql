-- =============================================================================
-- PEAK 1031 V1 PLATFORM - FEATURE-READY DATABASE MIGRATION
-- =============================================================================
...
-- Users can only see exchanges they're assigned to
CREATE POLICY exchange_participants_access ON exchange_participants
FOR ALL TO authenticated
USING (
  contact_id = (SELECT id FROM contacts WHERE email = auth.email()) OR
  EXISTS (
...
-- 3. Configure RLS policies for your auth system
